...
class Usuario_Externo(models.Model):
    ...
    responsavel_nome = models.CharField(max_length=50, null=True, blank=True, validators=[validate_nome], default='Vazio')
    responsavel_cpf = models.CharField(max_length=14, null=True, blank=True, validators=[validate_cpf], default='Vazio')
