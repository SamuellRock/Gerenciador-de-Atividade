...
class Usuario_Externo(models.Model):
    ...
    responsavel_nome = models.CharField(max_length=50, null=True, blank=True, validators=[validate_nome], default='Vazio', verbose_name='Nome do Responsavel')
    responsavel_cpf = models.CharField(max_length=14, null=True, blank=True, validators=[validate_cpf], default='Vazio', verbose_name='CPF do Responsavel')
